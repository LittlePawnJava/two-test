...
public class WeightQuickUnionUFCompressionPath implements UnionFind {
    private int[] parent;
    private int count;//多少组
    private int[] size;//每颗树大小

    public WeightQuickUnionUFCompressionPath(int n) {
        count = n;
        parent = new int[n];
        size= new int[n];
        for (int i = 0; i < n; i++) {
    ...
    public  static void main(String[] args) {
        int N = 100000000;
        UnionFind uf = new WeightQuickUnionUFCompressionPath(N);
